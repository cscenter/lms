...
urlpatterns = [
    ...
    path('users/<str:encoded_pk>/classes.ics', ICalClassesView.as_view(), name='user_ical_classes'),
    path('users/<str:encoded_pk>/assignments.ics', ICalAssignmentsView.as_view(), name='user_ical_assignments'),
    path('users/<str:encoded_pk>/interviews.ics', ICalInterviewsView.as_view(), name='user_ical_interviews'),
