...
from learning.teaching.views.assignments import (
    ...
    StudentAssignmentDetailView, AssignmentStatusChangeReportCSVView
)
...
urlpatterns = [
    ...
    path('assignments/', include([
        ...
        path('<int:pk>/export/status-changes', AssignmentStatusChangeReportCSVView.as_view(), name='assignment_status_report_csv'),
