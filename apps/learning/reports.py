    ...
    def _export_row(
        ...
        **kwargs,
        ...
        return [
            ...
            getattr(student_account.yandex_data, 'login', '') if hasattr(student_account, 'yandex_data') else '',
    ...
    def _export_row(
        ...
        *,
        ...
        return [
            ...
            student.phone,
            student.workplace,
            getattr(student.yandex_data, 'login', '') if hasattr(student, 'yandex_data') else '',
