...
def test_campaign_create_contest_results_import_task(client):
    ...
    url = reverse('admission:api:import_contest_results', kwargs={'campaign_id': campaign.id,
    ...
    wrong_url = reverse('admission:api:import_contest_results', kwargs={'campaign_id': campaign.id,
