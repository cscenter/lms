...
from .views import (
    ApplicationFormSubmissionByDays,
    ApplicationSubmission,
    CampaignResultsByCourses,
    CampaignResultsByUniversities,
    CampaignStagesByCourses,
    CampaignStagesByUniversities,
    CampaignStagesByYears,
    CampaignStatsApplicantsResults,
    CampaignStatsExamScoreByCourses,
    CampaignStatsExamScoreByUniversities,
    CampaignStatsStudentsResults,
    CampaignStatsTestingScoreByCourses,
