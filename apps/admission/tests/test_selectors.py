...
def test_get_acceptance():
    acceptance = AcceptanceFactory(status=Acceptance.CONFIRMED,
                                   applicant__campaign__year=2011)
    ...
    assert get_acceptance(year=2011, access_key=acceptance.access_key, filters=[Q(status=Acceptance.WAITING)]) is None
