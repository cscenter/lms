...
export default class CampaignTestScore extends mix(PlotOptions).with(PlotTypeOptionMixin) {
    static PLOT_TYPES = {
        "universities": {
            type: "universities",
            entry_point: "stats-api:stats_admission_campaign_testing_score_by_university",
        },
        "courses": {
            type: "courses",
            entry_point: "stats-api:stats_admission_campaign_testing_score_by_course",
        }
    };
