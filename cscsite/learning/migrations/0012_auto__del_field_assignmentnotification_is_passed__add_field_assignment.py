...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentNotification.is_passed'
        db.delete_column(u'learning_assignmentnotification', 'is_passed')

        # Adding field 'AssignmentNotification.is_about_passed'
        db.add_column(u'learning_assignmentnotification', 'is_about_passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssignmentNotification.is_passed'
        db.add_column(u'learning_assignmentnotification', 'is_passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AssignmentNotification.is_about_passed'
        db.delete_column(u'learning_assignmentnotification', 'is_about_passed')
    ...
    models = {
        ...
        u'learning.assignmentnotification': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_about_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
