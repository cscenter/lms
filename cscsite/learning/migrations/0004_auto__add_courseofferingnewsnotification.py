...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseOfferingNewsNotification'
        db.create_table(u'learning_courseofferingnewsnotification', (
            ...
            ('course_offering_news', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.CourseOfferingNews'])),
        ...
        db.send_create_signal(u'learning', ['CourseOfferingNewsNotification'])


    def backwards(self, orm):
        # Deleting model 'CourseOfferingNewsNotification'
        db.delete_table(u'learning_courseofferingnewsnotification')
