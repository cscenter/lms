...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OverallGrade.student'
        db.alter_column(u'learning_overallgrade', 'student_id', self.gf('annoying.fields.AutoOneToOneField')(unique=True, to=orm['users.CSCUser']))

    def backwards(self, orm):

        # Changing field 'OverallGrade.student'
        db.alter_column(u'learning_overallgrade', 'student_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.CSCUser'], unique=True))
