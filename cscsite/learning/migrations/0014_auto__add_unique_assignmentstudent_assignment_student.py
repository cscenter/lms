...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AssignmentStudent', fields ['assignment', 'student']
        db.create_unique(u'learning_assignmentstudent', ['assignment_id', 'student_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AssignmentStudent', fields ['assignment', 'student']
        db.delete_unique(u'learning_assignmentstudent', ['assignment_id', 'student_id'])
