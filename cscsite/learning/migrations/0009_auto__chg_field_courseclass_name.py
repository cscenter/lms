...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseClass.name'
        db.alter_column(u'learning_courseclass', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CourseClass.name'
        db.alter_column(u'learning_courseclass', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))
