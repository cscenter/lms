...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentNotification.is_about_created'
        db.delete_column(u'learning_assignmentnotification', 'is_about_created')

        # Adding field 'AssignmentNotification.is_about_creation'
        db.add_column(u'learning_assignmentnotification', 'is_about_creation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AssignmentNotification.is_about_deadline'
        db.add_column(u'learning_assignmentnotification', 'is_about_deadline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssignmentNotification.is_about_created'
        db.add_column(u'learning_assignmentnotification', 'is_about_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AssignmentNotification.is_about_creation'
        db.delete_column(u'learning_assignmentnotification', 'is_about_creation')

        # Deleting field 'AssignmentNotification.is_about_deadline'
        db.delete_column(u'learning_assignmentnotification', 'is_about_deadline')
