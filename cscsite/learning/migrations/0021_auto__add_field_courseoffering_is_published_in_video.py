...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOffering.is_published_in_video'
        db.add_column(u'learning_courseoffering', 'is_published_in_video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOffering.is_published_in_video'
        db.delete_column(u'learning_courseoffering', 'is_published_in_video')
