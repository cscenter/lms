...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NonCourseEvent'
        db.create_table(u'learning_noncourseevent', (
        ...
        db.send_create_signal(u'learning', ['NonCourseEvent'])


    def backwards(self, orm):
        # Deleting model 'NonCourseEvent'
        db.delete_table(u'learning_noncourseevent')
    ...
    models = {
        ...
        u'learning.noncourseevent': {
            'Meta': {'object_name': 'NonCourseEvent'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'ends_at': ('django.db.models.fields.TimeField', [], {}),
