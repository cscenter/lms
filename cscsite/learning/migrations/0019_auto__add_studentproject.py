...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'learning_studentproject', (
            ...
            ('project_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('presentation', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'learning', ['StudentProject'])

        # Adding M2M table for field semesters on 'StudentProject'
        m2m_table_name = db.shorten_name(u'learning_studentproject_semesters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentproject', models.ForeignKey(orm[u'learning.studentproject'], null=False)),
            ('semester', models.ForeignKey(orm[u'learning.semester'], null=False))
        ))
        db.create_unique(m2m_table_name, ['studentproject_id', 'semester_id'])


    def backwards(self, orm):
        # Deleting model 'StudentProject'
        db.delete_table(u'learning_studentproject')

        # Removing M2M table for field semesters on 'StudentProject'
        db.delete_table(db.shorten_name(u'learning_studentproject_semesters'))
