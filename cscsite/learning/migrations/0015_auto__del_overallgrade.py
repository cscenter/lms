...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OverallGrade'
        db.delete_table(u'learning_overallgrade')


    def backwards(self, orm):
        # Adding model 'OverallGrade'
        db.create_table(u'learning_overallgrade', (
            ...
            ('student', self.gf('annoying.fields.AutoOneToOneField')(related_name=u'overall_grade', unique=True, to=orm['users.CSCUser'])),
            ('grade_changed', self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor=u'grade')),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'learning', ['OverallGrade'])
