...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venue.is_preferred'
        db.add_column(u'learning_venue', 'is_preferred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.is_preferred'
        db.delete_column(u'learning_venue', 'is_preferred')
