...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Enrollment', fields ['student', 'course_offering']
        db.create_unique(u'learning_enrollment', ['student_id', 'course_offering_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Enrollment', fields ['student', 'course_offering']
        db.delete_unique(u'learning_enrollment', ['student_id', 'course_offering_id'])
