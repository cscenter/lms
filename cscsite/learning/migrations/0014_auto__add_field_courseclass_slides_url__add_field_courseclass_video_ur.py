...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseClass.video_url'
        db.add_column(u'learning_courseclass', 'video_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseClass.slides_url'
        db.delete_column(u'learning_courseclass', 'slides_url')

        # Deleting field 'CourseClass.video_url'
        db.delete_column(u'learning_courseclass', 'video_url')
