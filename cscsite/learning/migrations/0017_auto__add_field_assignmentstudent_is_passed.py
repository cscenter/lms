...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentStudent.is_passed'
        db.add_column(u'learning_assignmentstudent', 'is_passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        if not db.dry_run:
            for a_s in orm.AssignmentStudent.objects.all():
                if ((orm.AssignmentComment.objects
    ...
    def backwards(self, orm):
        # Deleting field 'AssignmentStudent.is_passed'
        db.delete_column(u'learning_assignmentstudent', 'is_passed')
