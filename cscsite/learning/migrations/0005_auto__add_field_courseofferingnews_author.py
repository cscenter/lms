...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseOfferingNews.author'
        db.add_column(u'learning_courseofferingnews', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.CSCUser'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseOfferingNews.author'
        db.delete_column(u'learning_courseofferingnews', 'author_id')
