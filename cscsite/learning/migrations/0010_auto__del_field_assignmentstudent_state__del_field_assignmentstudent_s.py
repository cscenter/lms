...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentStudent.state'
        db.delete_column(u'learning_assignmentstudent', 'state')

        # Deleting field 'AssignmentStudent.state_changed'
        db.delete_column(u'learning_assignmentstudent', 'state_changed')

        # Adding field 'AssignmentStudent.grade'
        db.add_column(u'learning_assignmentstudent', 'grade',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AssignmentStudent.grade_changed'
        db.add_column(u'learning_assignmentstudent', 'grade_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor=u'grade'),
                      keep_default=False)

        # Adding field 'Assignment.grade_min'
        db.add_column(u'learning_assignment', 'grade_min',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Assignment.grade_max'
        db.add_column(u'learning_assignment', 'grade_max',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssignmentStudent.state'
        db.add_column(u'learning_assignmentstudent', 'state',
                      self.gf('model_utils.fields.StatusField')(default=u'not_checked', max_length=100, no_check_for_status=True),
                      keep_default=False)

        # Adding field 'AssignmentStudent.state_changed'
        db.add_column(u'learning_assignmentstudent', 'state_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor=u'state'),
                      keep_default=False)

        # Deleting field 'AssignmentStudent.grade'
        db.delete_column(u'learning_assignmentstudent', 'grade')

        # Deleting field 'AssignmentStudent.grade_changed'
        db.delete_column(u'learning_assignmentstudent', 'grade_changed')

        # Deleting field 'Assignment.grade_min'
        db.delete_column(u'learning_assignment', 'grade_min')

        # Deleting field 'Assignment.grade_max'
        db.delete_column(u'learning_assignment', 'grade_max')
