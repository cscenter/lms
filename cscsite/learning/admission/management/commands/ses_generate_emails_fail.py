...
# ./manage.py ses_generate_emails_fail --passing_score=7 --template=admission-2016-online-test-fail --campaign_id=2
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        failed_applicants = (Applicant.objects.filter(campaign_id=campaign_id,
                                                       online_test__score__lt=passing_score)
