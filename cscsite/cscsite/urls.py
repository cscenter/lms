...
from users.views import LoginView, LogoutView, TeacherDetailView, \
    UserDetailView, UserUpdateView, ICalView
...
urlpatterns = patterns('',
    ...
    url(r'^users/(?P<pk>\d+)/$', UserDetailView.as_view(),
        name='user_detail'),
    url(r'^users/(?P<pk>\d+)/csc.ics', ICalView.as_view(),
        name='user_ical'),
    ...
    url(r'^teaching/add-assignment/$',
        ...
        name='assignment_add'),
    url(r'^teaching/edit-assignment-(?P<pk>\d+)/$',
        AssignmentUpdateView.as_view(),
        name='assignment_edit'),
    url(r'^teaching/delete-assignment-(?P<pk>\d+)/$',
    ...
    url(r"^courses/(?P<course_slug>[-\w]+)/(?P<semester_slug>[-\w]+)/edit-news-(?P<pk>\d+)/$",
        CourseOfferingNewsUpdateView.as_view(),
        name="course_offering_news_update"),
    url(r"^courses/(?P<course_slug>[-\w]+)/(?P<semester_slug>[-\w]+)/delete-news-(?P<pk>\d+)/$",
    ...
    url(r"^courses/(?P<course_slug>[-\w]+)/(?P<semester_slug>[-\w]+)/(?P<pk>\d+)/$",
