...
Добавить поля `yandex_id` и `score`. Это минимум.
По `yandex_id` и указанному в консоли `campaign_id` будет найден id поступающего.
...
yandex_id,"Задача 1(Предел функции)","Задача 2(Площадь фигуры)","score"
