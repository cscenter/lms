...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSCUser.yandex_id'
        db.add_column(u'users_cscuser', 'yandex_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'CSCUser.stepic_id'
        db.add_column(u'users_cscuser', 'stepic_id',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSCUser.yandex_id'
        db.delete_column(u'users_cscuser', 'yandex_id')

        # Deleting field 'CSCUser.stepic_id'
        db.delete_column(u'users_cscuser', 'stepic_id')
