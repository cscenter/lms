...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSCUser.private_contacts'
        db.add_column(u'users_cscuser', 'private_contacts',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSCUser.private_contacts'
        db.delete_column(u'users_cscuser', 'private_contacts')
