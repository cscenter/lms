...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CSCUser.enrolment_year'
        db.delete_column(u'users_cscuser', 'enrolment_year')

        # Adding field 'CSCUser.enrollment_year'
        db.add_column(u'users_cscuser', 'enrollment_year',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CSCUser.enrolment_year'
        db.add_column(u'users_cscuser', 'enrolment_year',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CSCUser.enrollment_year'
        db.delete_column(u'users_cscuser', 'enrollment_year')
