...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CSCUser.stepic_id'
        db.alter_column(u'users_cscuser', 'stepic_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CSCUser.stepic_id'
        db.alter_column(u'users_cscuser', 'stepic_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
