    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_last_change', users.models.MonitorStatusField(blank=True, editable=False, logging_model=users.models.CSCUserStatusLog, monitored='status', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.CSCUserStatusLog', verbose_name='Status changed')),
